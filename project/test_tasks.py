...
class AllTests(unittest.TestCase):
	...
	def create_admin_user(self):
		new_user = User(name='Superman', email='admin@realpython.com', password='allpwerful', role='admin')
		db.session.add(new_user)
		db.session.commit() 
	...
	# 	new_user = User("michael", "michael@mherman.com", "michaelerman")
	# 	db.session.add(new_user)
	# 	db.session.commit()
	...
	# 	self.register('Michael', 'michael@realpython.ca', 'python', 'python')
	...
	def test_users_cannot_add_taks_when_error(self):
		self.create_user('Michael', 'michael@realpython.com', 'python')
		self.login('Michael', 'python')
		self.app.get('tasks/', follow_redirects=True)
	...
	def test_useres_can_delete_tasks(self):
		self.create_user('Michael', 'michael@realpython.com', 'python')
		self.login('Michael', 'python')
		self.app.get('tasks/', follow_redirects=True)
		self.create_task()
